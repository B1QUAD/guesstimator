const baseURL = 'https://emgithub.com/embed.js'

// #############################################################################
// "If something does not work the way you want it to, make it."               #
// -Master Oogway                                                              #
// #############################################################################
// This was all done because the browser will not let you dynamically load JS  #
// asyncronously and then try to run it because it can cause a race condition. #
...
function embed(parameters) {
  ...
  const sourceURL = new URL(`${baseURL}${parameters}`);
  ...
  const containerId = 'embedContainer';
